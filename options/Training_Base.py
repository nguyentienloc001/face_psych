...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', type=str, default='Deep_Generation',
        ...
        # nc有改
        self.parser.add_argument('--label_nc', type=int, default=1, help='# of input label channels')
        ...
        # 长度有改
        self.parser.add_argument('--feat_num', type=int, default=512, help='vector length for encoded features')
